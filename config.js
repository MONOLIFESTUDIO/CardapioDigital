...
const MENU_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS5NLAFgMwkXskr8Bv20WcGgqX9VCJzEvwQNe11ISZsC3Q7mWVuccu8f-EOdnKhLCI2ZfgvfLWHcP90/pub?gid=1132427241&single=true&output=csv';

// URL of the spreadsheet with menu categories (tab: Categories)
const CATEGORIES_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS5NLAFgMwkXskr8Bv20WcGgqX9VCJzEvwQNe11ISZsC3Q7mWVuccu8f-EOdnKhLCI2ZfgvfLWHcP90/pub?gid=271394769&single=true&output=csv';

// URL of the spreadsheet with general settings (tab: Config)
const CONFIG_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS5NLAFgMwkXskr8Bv20WcGgqX9VCJzEvwQNe11ISZsC3Q7mWVuccu8f-EOdnKhLCI2ZfgvfLWHcP90/pub?gid=0&single=true&output=csv';

// URL of the spreadsheet with operating hours (tab: Hours)
const HOURS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS5NLAFgMwkXskr8Bv20WcGgqX9VCJzEvwQNe11ISZsC3Q7mWVuccu8f-EOdnKhLCI2ZfgvfLWHcP90/pub?gid=1842804489&single=true&output=csv';

// URL of the spreadsheet with neighborhoods and delivery fees (tab: Bairros) **OPCIONAL**
const NEIGHBORHOODS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS5NLAFgMwkXskr8Bv20WcGgqX9VCJzEvwQNe11ISZsC3Q7mWVuccu8f-EOdnKhLCI2ZfgvfLWHcP90/pub?gid=1634629476&single=true&output=csv';

// URL da planilha de cupons de desconto  **OPCIONAL**
const COUPONS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS5NLAFgMwkXskr8Bv20WcGgqX9VCJzEvwQNe11ISZsC3Q7mWVuccu8f-EOdnKhLCI2ZfgvfLWHcP90/pub?gid=1144201431&single=true&output=csv';
...
// const PRELOADER_LOGO_URL = 'https://drive.google.com/file/d/1r-m9txwTIFxbY5S4QysZTkEvbYTrvbcY/view'; // Adicione a URL do seu logo aqui
 ...
 */
// const PRELOADER_COLOR = '#8844EE'; // Cor principal do preloader
const PRELOADER_COLOR = '#FFFFFF';
